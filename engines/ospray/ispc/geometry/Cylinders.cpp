...
void Cylinders::finalize(Model* model)
{
    ...
    ispc::CylindersGeometry_set(getIE(), model->getIE(), cylinderData->data,
                                materialList ? ispcMaterialPtrs.data()
                                             : nullptr,
                                ...
                                numCylinders, bytesPerCylinder, radius,
                                materialID, offset_v0, offset_v1, offset_radius,
